...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/dashboard/overview": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "X, Instagram, TikTok, News, or YouTube — omit for all platforms",
                        "name": "platform",
                        "in": "query"
                    }
                ],
        ...
        "/mentions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "newest (default), oldest, or engagement",
                        "name": "sort",
                        "in": "query"
                    }
                ],
        ...
        "/settings/preferences": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Preference key and new checked state",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdatePreferenceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handler.UpdatePreferenceRequest": {
            "type": "object",
            "required": [
                "key"
            ],
